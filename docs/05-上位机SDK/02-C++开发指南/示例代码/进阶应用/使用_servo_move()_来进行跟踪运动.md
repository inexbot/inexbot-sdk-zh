...
struct ServoMovePara {
  ...
  int coord;                                // 0-关节 1-直角
  int size;                                 // 本次传输的点位数
  std::vector<std::vector<double>> pos;     // 二维数组，一维表示本次传输的点位数，二维长度为7
  std::vector<std::vector<double>> axisvel; // 二维数组，一维表示本次传输的点位数，二维长度为7
  std::vector<std::vector<double>> axisacc; // 二维数组，一维表示本次传输的点位数，二维长度为7
